        ...
        t(:div, {className: 'list-group'},
          ...
          *splat_each(state.blogs) do |blog|
            t(:div, {className: 'list-group-item'}, 
              t(:p, {}, 
                t(:span, {}, 
                  t(:img, {src: blog.user.try(:avatar).try(:url), style: {hight: '50px', width: '50px'}.to_n}),
              ...
              t(:p, {className: 'created_at'},
                Moment.new(blog.attributes[:published_at]).format('YYYY.MM.DD')
