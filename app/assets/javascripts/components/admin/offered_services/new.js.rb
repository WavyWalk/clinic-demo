  ...
  module Admin  
    module OfferedServices
      class New < RW
        ...
        def render
          t(:div, {className: 'offered_services_new_edit'},
            if state.current_user.has_role? :admin
              t(:div, {},
                ...
                t(:div, {className: 'add_associated_price_items'},
                ...
                t(:button, {className: 'btn btn-primary', onClick: ->(){handle_inputs}}, "create offered service")
              )
            end
          )
        end
