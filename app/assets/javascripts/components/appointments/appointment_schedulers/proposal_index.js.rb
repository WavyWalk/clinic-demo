  ...
  module Appointments
    module AppointmentSchedulers
      class ProposalIndex < RW
              ...
              t(:tbody, {},
                *splat_each(state.appointments) do |appointment|
                  ...
                  t(:tr, {key: appointment.id},
                    t(:td, {},
                      t(:button, {onClick: ->{init_patient_show(appointment.patient.id)}},
                        "#{appointment.id} manage"
                      )
                    ),
                    t(:td, {},
        ...
        def init_patient_show(id)
          modal_open(
            'manage patient',
            t(Components::AppointmentSchedulers::Users::Show, {user_id: id})
          )
        end
