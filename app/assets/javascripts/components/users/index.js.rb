  ...
  module Users
    class Index < RW
      ...
      def make_query(_extra_params)
        ...
        _extra_params[:per_page] = _extra_params[:per_page] || props.location.query.per_page || 25
      ...
      def per_page_select(value) #from Plugins::Paginatable
        ...
        c_q[:per_page] = value
        c_q[:page] = 1
        set_state({pagination_per_page: value.to_i})
      ...
      def collect_search_hash()
        ...
        ex_p[:roles] = roles
        ex_p[:per_page] = props.location.query.per_page || 25
