  ...
  module AppointmentSchedulers
    module Users
      class Index < RW
        ...
        def render
          t(:div, {className: 'appointment_scheduler_patients_index'},
            modal,
            ...
            t(:div, {className: 'search_results'},
              *splat_each(state.users) do |user|
                t(:div, {className: 'user_box'},
                  ...
                  t(:div, {},
                    t(:button, {onClick: ->{init_patient_show(user)}}, 'manage patient'),  
        ...
        def init_patient_show(patient)
          modal_open(
            'manage patient',
            t(Components::AppointmentSchedulers::Users::Show, {user_id: patient.id})
          )
        end
